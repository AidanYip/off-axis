...
const AdminPastGigsList: React.FC = () => {
  ...
  useEffect(() => {
      const fetchGigs = async () => {
        try {
          const response = await fetch("/api/admin/getAllPastGigsArtistInfo");
  ...
  return (
    <>
      <h4 className="p-2 text-start">Past Gigs</h4>
...
export default AdminPastGigsList;