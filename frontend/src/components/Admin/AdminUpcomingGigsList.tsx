...
const AdminUpcomingGigsList: React.FC = () => {
  ...
  useEffect(() => {
      const fetchGigs = async () => {
        try {
          const response = await fetch("/api/admin/getAllUpcomingGigsArtistInfo");
  ...
  return (
    <>
      <h4 className="p-2 text-start">Upcoming Gigs</h4>
...
export default AdminUpcomingGigsList;